...
@SourceType(value = "ServiceNowARP", label = "ServiceNow",uiConfig = "servicenow-layout.json")
public class ServiceNowConf extends AbstractArpConf<ServiceNowConf> {
  private static final String ARP_FILENAME = "arp/implementation/servicenow-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.servicenow.ServiceNowDriver";
